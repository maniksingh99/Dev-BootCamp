...
(async function(){
    try{
        ...
        await inputBoxArr[1].sendKeys(question[0]["Input Format"]);
        await inputBoxArr[2].sendKeys(question[0]["Constraints"]);
        await inputBoxArr[3].sendKeys(question[0]["Output Format"]);
